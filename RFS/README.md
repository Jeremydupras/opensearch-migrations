...
For backfill investigations, see the [failed document stream reference](../docs/failedDocumentStream.md) for where terminal document failures are stored and how to inspect them.
